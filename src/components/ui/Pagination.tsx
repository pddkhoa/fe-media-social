...
const classes = {
    base: {
        item: "[&>.rc-pagination-item>a]:text-gray-700 [&>.rc-pagination-item>a]:font-medium [&>li.rc-pagination-item]:border-gray-300  [&>.rc-pagination-item>a]:focus:text-white [&>.rc-pagination-item:not(.rc-pagination-item-active)]:bg-transparent",
    ...
    variant: {
        solid: {
            base: "[&>.rc-pagination-item-active>a]:!text-gray-400  [&>.rc-pagination-item-active>a]:hover:text-gray-400",
            color: {
                DEFAULT:
                    "[&>.rc-pagination-item-active]:bg-primary [&>li.rc-pagination-item-active]:border-gray-900 [&>.rc-pagination-item-active]:hover:border-gray-900 [&>.rc-pagination-item-active]:focus:border-gray-900 dark:[&>.rc-pagination-item-active]:bg-primary dark:[&>.rc-pagination-item-active>a]:!text-gray-400 dark:[&>.rc-pagination-item-active>a]:hover:text-gray-700 dark:[&>li.rc-pagination-item-active]:border-gray-200 dark:[&>.rc-pagination-item-active]:hover:border-gray-200 dark:[&>.rc-pagination-item-active]:focus:border-gray-200",
            },
        },
        flat: {
            base: "",

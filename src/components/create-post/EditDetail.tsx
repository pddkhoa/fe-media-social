...
import { pageLinks } from "../search/RouterLink.data";
...
const EditDetail = () => {
  ...
  return (
    <div className="flex flex-col gap-5">
      <Textarea label="Descripstion" placeholder="Descriptions" />
      <Select
        options={options}
        label="Categories"
        value={value}
      ...
      <div className="border p-4 rounded-md">
        <div className="flex gap-5">
          <Badge rounded="md" className="flex gap-3">
            <span>#Badge</span>
            <span className="hover:bg-slate-500  p-0.5 rounded-md cursor-pointer">
              <PiXBold />
            </span>
          </Badge>
        </div>
      ...
      <div>
        <Button
          ...
          variant="text"
          onClick={() => {
            openModal({ view: <UploadModal isPost={true} /> });
          }}
        >
